...
public class Config extends YamlManager {
    ...
    public Config(ChestShop plugin) {
        ...
        set("shops.max-shops.default", 0,
                Arrays.asList("The maximum amount of shops a player can have. Set to 0 for unlimited. If a player has more than one permission, the highest amount will be used."));
