...
public enum Message {
    ...
    SHOP_BOUGHT("shop.bought", "%prefix% &aYou bought &7x%items-bought% &f%item% &afor &f$%price%&a! &7(&8%items-left%&7)"),
    SHOP_SOLD_TO("shop.sold-to", "%prefix% &aYou sold &7x%items-sold% &f%item% &afor &f$%price%&a!"),
    SHOP_BOUGHT_FROM("shop.bought-from", "%prefix% &aYou bought &7x%items-bought% &f%item% &afor &f$%price%&a from &f%player-name%&a!"),
    ...
    SHOP_CHEST_FULL_OWNER("shop.chest-full-owner", "%prefix% &c%player-name% &ctried to sell &7x%amount% &f%item% &cbut %shop-name%'s chest is full!"),
    ...
    SHOP_LIST_SHOPS_HOVER("shop.list.shops-hover",
            "&6&l%item%&r\n &8- &7price: &6$&a%sell-price%&e/&6$&c%buy-price%\n &8- &7items left: &e%items-left%\n &8- &7location: &e%location%\n &8- &7created at: &e%created%"),
    ...
    SHOP_OWNER_NO_MONEY("shop.owner-no-money", "%prefix% &cThe shop owner doesn't have enough money to buy your items!"),
    SHOP_OWNER_NO_MONEY_OWNER("shop.owner-no-money-owner", "%prefix% &c%player-name% &ctried to sell &f%item% &cfor &f$%price% &cbut you don't have enough money!"),
    ...
    SHOP_SOLD("shop.sold", "%prefix% &aYou sold &7x%items-bought% &f%item% &afor &f$%price%&a, to &f%player-name%&a! &7(&8%items-left%&7)"),
