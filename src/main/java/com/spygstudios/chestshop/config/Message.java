...
public enum Message {
    ...
    NOT_ENOUGH_ITEMS("not-enough-items", "%prefix% &cYou don't have enough &f%material% &c(&e%amount%&c required)!"),
    ...
    SHOP_SOLD_TO("shop.sold-to", "%prefix% &aYou sold &7x%items-sold% &f%material% &afor &f$%price%&a!"),
    ...
    SHOP_OWNER_NO_MONEY_OWNER("shop.owner-no-money-owner", "%prefix% &c%player-name% &ctried to sell &f%material% &cfor &f$%price% &cbut you don't have enough money!"),
